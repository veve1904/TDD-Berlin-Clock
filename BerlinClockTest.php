...
class BerlinClockTest extends TestCase {
    ...
    public function test_CalculateHoursBy5_give15h00_returnRRR(){
        $test = new BerlinClock();
        $timer = "15:00:00";
        $actual = $test->calculateHoursBy5($timer);
        $this->assertEquals("RRR",$actual);
    }
    public function test_CalculateHoursBy5_give20h00_returnRRRR(){
        $test = new BerlinClock();
        $timer = "20:00:00";
        $actual = $test->calculateHoursBy5($timer);
        $this->assertEquals("RRRR",$actual);
    }
    public function test_CalculateSecond_givePairSecond_returnR(){
        $test = new BerlinClock();
        $timer = "20:00:46";
        $actual = $test->calculateSeconds($timer);
        $this->assertEquals("R",$actual);
    }
    public function test_CalculateSecond_giveImpairSecond_returnNothing(){
        $test = new BerlinClock();
        $timer = "13:00:13";
        $actual = $test->calculateSeconds($timer);
        $this->assertEquals("",$actual);
    ...
    public function test_CalculateTime_give01h05m01_returnccRcYc(){
        $test = new BerlinClock();
        $timer = "01:05:01";
        $actual = $test->calculateTime($timer);
        $this->assertEquals("ccRcYc",$actual);
    }
    public function test_CalculateTime_give02h12m22_returnRccRRcYYcYY(){
        $test = new BerlinClock();
        $timer = "02:12:22";
        $actual = $test->calculateTime($timer);
        $this->assertEquals("RccRRcYYcYY",$actual);
    }
    public function test_CalculateTime_give23h59m58_returnRcRRRRcRRRcYYRYYRYYRYYcYYYY(){
        $test = new BerlinClock();
        $timer = "23:59:58";
        $actual = $test->calculateTime($timer);
        $this->assertEquals("RcRRRRcRRRcYYRYYRYYRYYcYYYY",$actual);
    }
